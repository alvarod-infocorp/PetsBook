...
public class MainActivity extends ActionBarActivity implements
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_settings:
			break;
		case R.id.menu_action_lost:
			Intent menu_action_lost = new Intent(this, listaPerdidos.class);
			startActivity(menu_action_lost);
			break;
		case R.id.menu_action_found:
			Intent menu_action_found = new Intent(this, listaPerdidos.class);
			startActivity(menu_action_found);
			break;
		default:
			Intent action_lost = new Intent(this, listaPerdidos.class);
			startActivity(action_lost);
			break;
		}
